...
import {UserOutlined,ShoppingCartOutlined,HeartOutlined,LogoutOutlined} from '@ant-design/icons';
...
export default function Header() {
    return (
        <div>
            ...
            <li className="nav-item ml-3">
            <Link to="/vegetable"> 
            <a className="vegetable" href="#">Vegetable</a>
            </Link>    
            </li>
            <li className="nav-item ml-3">
             <Link to="fruits">
             <a className="fruits" href="#">Fruits</a>
            </Link> 
            </li>
            <li className="nav-item ml-3">
            <Link to="daily products">
            <a className="daily" href="#">Daily Products</a>
            </Link>    
            </li>
            <li className="nav-item ml-3">
            <Link to="organic">
            <a className="organic" href="#">Organic Box</a>
            </Link>    
            </li>
            <li className="nav-item ml-3">
            <Link to="contact">
